...
return [
    ...
    'attributes' => [
        'client.group_id' => 'cooperativa',
        'client.name' => 'nome',
        'client.mom_name' => 'nome da mãe',
        'client.date_birth' => 'data de nascimento',
        'client.cpf' => 'cpf',
        'client.rg' => 'rg',
        'client.gender' => 'gênero',
        'client.marital_status' => 'estado civil',
        ...
        'client.city' => 'cidade',
        'client.state' => 'estado',
        'client.obs' => 'observação',

        'seller.group_id' => 'cooperativa',
        'seller.name' => 'nome',
        'seller.date_birth' => 'data de nascimento',
        'seller.cpf' => 'cpf',
        'seller.rg' => 'rg',
        'seller.phone' => 'telefone',
        'seller.email' => 'email',
        'seller.comission_type' => 'tipo de comissão',
        'seller.comission_value' => 'valor da comissão',
        'seller.comission_recurrence' => 'recorrência comissão',    
        'seller.zipcode' => 'cep',
        'seller.address' => 'endereço',
        'seller.number' => 'número',
        'seller.complement' => 'complemento',
        'seller.neighborhood' => 'bairro',
        'seller.city' => 'cidade',
        'seller.state' => 'estado',
        'seller.obs' => 'observação',
        'seller.status' => 'status',

        'group.group_name' => 'razão social',
        'group.name' => 'nome fantasia',
        'group.document' => 'cnpj',
        'group.phone' => 'telefone',
        'group.email' => 'email',
        'group.whatsapp' => 'whatsapp',
        'group.site' => 'site',
        'group.zipcode' => 'cep',
        'group.address' => 'endereço',
        'group.number' => 'número',
        'group.complement' => 'complemento',
        'group.neighborhood' => 'bairro',
        'group.city' => 'cidade',
        'group.state' => 'estado',
        'group.status' => 'status',
