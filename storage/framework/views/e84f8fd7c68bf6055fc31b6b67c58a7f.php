                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-<?php echo e($client->status ? 'success' : 'danger'); ?>">
                                        <?php echo e($client->status ? 'Ativo' : 'Inativo'); ?>

                                    </span>
                                </td>
                                <td class="text-center">
                                    <a 
                                        href="<?php echo e(route('admin.clients.edit', $client->id)); ?>" 
                                ...
                                <td class="text-center">
                                    <button 
                                        wire:click="confirmDelete(<?php echo e($client->id); ?>)" 
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pagination','data' => ['paginator' => $clients]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH /var/www/html/resources/views/livewire/clients-list.blade.php ENDPATH**/ ?>