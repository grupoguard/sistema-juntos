            ...
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-md-4 text-end">
                        <a 
                            href="<?php echo e(route('admin.sellers.create')); ?>" 
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-<?php echo e($seller->status ? 'success' : 'danger'); ?>">
                                        <?php echo e($seller->status ? 'Ativo' : 'Inativo'); ?>
                                ...
                                <td class="text-center">
                                    <button 
                                        wire:click="confirmDelete(<?php echo e($seller->id); ?>)" 
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pagination','data' => ['paginator' => $sellers]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($sellers)]); ?>
...
<?php /**PATH /var/www/html/resources/views/livewire/sellers-list.blade.php ENDPATH**/ ?>