    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $segment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($index < count($segments) - 1): ?>
                        <li class="breadcrumb-item text-sm">
                            <a href="<?php echo e($url); ?>" class="text-dark opacity-7">
                                <?php echo e($segmentName); ?>
            ...
            <h6 class="font-weight-bolder mb-0 text-capitalize">
                <?php echo e($aliases[$segments[count($segments) - 1]] ?? ucfirst(end($segments))); ?>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar"> 
            <ul class="navbar-nav justify-content-end">
                ...
                <li class="nav-item dropdown pe-2 d-flex align-items-center me-lg-3">
                                ...
                                <div class="d-flex py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="text-sm font-weight-normal mb-1">
                                            <span class="font-weight-bold">Novo Pedido</span> | Cooperativa de Santos
                                        </h6>
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="d-flex py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="text-sm font-weight-normal mb-1">
                                            <span class="font-weight-bold">Novo pedido</span> | Cooperativa Vitória
                                        </h6>
                                        <p class="text-xs text-secondary mb-0">
                                            <i class="fa fa-clock me-1"></i>
                                            1 dia
...
<!-- End Navbar --><?php /**PATH /var/www/html/resources/views/layouts/navbars/auth/nav.blade.php ENDPATH**/ ?>